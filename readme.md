...
Deploy the WebSocket server to the cloud for access from anywhere:
...
4. Use the URL: `wss://your-app.onrender.com` in Figma plugin
...
- ✅ Access from anywhere (no localhost needed)
- ✅ Free forever with Render.com
- ✅ Automatic SSL/HTTPS
